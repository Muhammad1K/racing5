class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 210, y: height - 1400, image: obstacle2Image },
      { x: width / 2 + 290, y: height - 2000, image: obstacle2Image },
      { x: width / 2 - 270, y: height - 4100, image: obstacle2Image },
     
      { x: width / 2 - 150, y: height - 4300, image: obstacle2Image },
      { x: width / 2, y: height - 5000, image: obstacle2Image },
    ];
